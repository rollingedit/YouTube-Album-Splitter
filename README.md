...
The dash can be a normal hyphen or longer dash. The tool also strips common extra upload text, things like `(Instrumental)`, `(Instrumental Only)`, `Full Album`, `Full EP`, and trailing years. For example, this title:
